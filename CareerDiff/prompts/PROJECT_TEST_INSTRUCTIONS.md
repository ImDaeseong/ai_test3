# CareerDiff — Claude/ChatGPT Projects test instructions

Paste this whole file into the Project's custom instructions (Claude: "Project instructions"; ChatGPT: "Instructions"). Upload SPEC.md, DATA_MODEL.md, ANALYSIS_FLOW.md, AI_EVALUATION_PLAN.md as knowledge files alongside it.
